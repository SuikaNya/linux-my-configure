...
" Version:  8.1.4.i.2
" Modifier: Jak Wings <jakwings@gmail.com>
" ----------------------------------------------------------------------------
"
...
if s:style == "light"
    ...
    elseif s:contrast == "high"
        ...
        " modification start
        hi MatchParen   guifg=#d7ff87   guibg=bg
        " modification end
        ...
        " modification start
        hi MatchParen   guifg=#afd75f   guibg=bg
        " modification end
        hi Search                       guibg=#d78700
...
if s:style == "light"
    ...
    if s:no_term_bg == 1
      ...
      hi LineNr       guifg=#949494   guibg=#444444
    endif
    " modification end
    ...
    if s:contrast == "low"
        ...
        " modification start
        hi StatusLine   guifg=#9e9e9e   guibg=#303030
        hi StatusLineNC guifg=#9e9e9e   guibg=#303030
        " modification start
    ...
    elseif s:contrast == "high"
        ...
        " modification start
        hi StatusLine   guifg=#ffffff   guibg=#585858
        hi StatusLineNC guifg=#ffffff   guibg=#585858
        " modification end
        ...
        " modification start
        hi StatusLine   guifg=#c6c6c6   guibg=#444444
        hi StatusLineNC guifg=#c6c6c6   guibg=#444444
        " modification end
